...
- 2026-08-28：厂商类型（Hikvision / Vzvision / Huaxiazhixin）下沉评估已写入 [`docs/2026-08-28-lpr-device-type-per-config/`](../../../2026-08-28-lpr-device-type-per-config/00-调研总览.md)；与本草稿「地磅/卡口/成品」业务角色分开。
