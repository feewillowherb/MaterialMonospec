...
<#
  Standalone Xiaoshan weighbridge probe for internal network.
  Params match pipelines/graphs/govsync/xiaoshan-weighbridge/config.yaml (2026-08-28).
...
$Url = "http://172.18.34.209:8899/sapi/v1/inoutRecord/lantu/saveRecord"
...
Write-Host "=== Xiaoshan weighbridge internal probe ===" -ForegroundColor Cyan
Write-Host "URL: $Url"
...
if (-not $SkipConfirm) {
    Write-Host ""
    Write-Host "WARNING: POST will WRITE a weighbridge record to the government platform." -ForegroundColor Yellow
