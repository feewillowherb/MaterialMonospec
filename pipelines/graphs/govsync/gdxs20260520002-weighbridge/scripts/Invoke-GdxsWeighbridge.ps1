...
<#
.SYNOPSIS
  Experimental cook: GDXS20260520002 Xiaoshan weighbridge POST probe.
.DESCRIPTION
...
$DefaultFixtureRel = "fixtures/16cfa8c48c427f193da61f7a6903f9d6.png"
...
Write-Host "[gdxs20260520002-weighbridge] experimental Invoke starting..."
...
if ([string]::IsNullOrWhiteSpace($slug)) { $slug = "gdxs20260520002-weighbridge" }
...
if (-not (Test-Path -LiteralPath $FixturePath)) {
    throw ("Missing fixture image: {0}. Run Copy-GdxsWeighbridgePackage.ps1 first." -f $FixturePath)
}
...
if (-not $SkipConfirm) {
    ...
    $ans2 = Read-Host ("POST weighbridge GDXS20260520002 will WRITE to government platform. Type YES to continue")
