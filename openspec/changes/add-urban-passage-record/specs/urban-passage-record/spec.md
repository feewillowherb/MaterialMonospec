...
The system MUST NOT call Xiaoshan `inoutRecord/save`, MUST NOT assemble Base64 snap images for upload, and MUST NOT extend weighing cloud upload for passage rows.

#### Scenario: Save stays local

- **WHEN** a passage record is created
- **THEN** persistence MUST complete without HTTP upload of that record
