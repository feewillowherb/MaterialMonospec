# Recycle Platform API Boundary

## Purpose

定义 Recycle 独立客户端对 BasePlatform / MaterialPlatform / Recycle 外部数据接口的 Refit 客户端边界：授权走 BasePlatform，登录仅用 MaterialPlatform，业务数据上报走 §2.2 `IRecycleDataApi`。
