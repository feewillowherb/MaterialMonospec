# Urban Weight Upload Unit

## Purpose

Defines the weight unit contract between MaterialClient.Urban (local storage in metric tons) and UrbanManagement (API and persistence in kilograms) during weighing record cloud upload.
