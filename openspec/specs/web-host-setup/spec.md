...
Defines the ASP.NET Core web host configuration, MVC service registration, static file serving, and ABP controller integration for the UrbanManagement application.
