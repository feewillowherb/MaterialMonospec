# Client Device Online Detail

## Purpose

Provides a detail page for viewing real-time online status of all device types for a specific client in the UrbanManagement system. Each client can have multiple devices (Scale, Camera, LPR, Sound, Printer), and this capability allows operators to view the aggregated online status of all devices for a specific client in real-time.
