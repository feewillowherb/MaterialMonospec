# MaterialClient Urban Installer Specification

## Purpose

定义 MaterialClient 子仓库中 MaterialClient.Urban 桌面应用的 Inno Setup 安装包脚本、发布前置命令与安装元数据，与主应用 `MaterialClient.iss` 并列维护。
