# Urban Weighing Record Pipeline Specification

## Purpose

Defines how UrbanMode (201) reuses the existing weighing device infrastructure for the urban weighing record pipeline.
