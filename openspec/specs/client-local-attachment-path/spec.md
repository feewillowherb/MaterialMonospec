# client-local-attachment-path Specification

## Purpose

Defines MaterialClient local attachment root and dated path conventions used by `AttachmentPathUtils` for camera and LPR storage.
