# Stable Immediate Match

## Purpose

Defines the optional `EnableMatchOnStable` configuration and behavior for publishing `TryMatchEvent` when weight stabilizes (with OffScale fallback / skip rules), without changing UrbanMode skip-matching semantics.
