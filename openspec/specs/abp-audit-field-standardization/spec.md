# ABP Audit Field Standardization Specification

## Purpose

Standardize audit fields (CreationTime, CreatorUserId, LastModificationTime, LastModifierUserId, IsDeleted, etc.) across UrbanManagement and MaterialClient entities using ABP framework conventions, ensuring automatic population by framework UnitOfWork/EF Core SaveChanges interceptors instead of manual assignment.
