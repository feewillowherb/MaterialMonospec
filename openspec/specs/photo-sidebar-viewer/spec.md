# Photo Sidebar Viewer Specification

## Purpose

定义图片侧边栏中照片的点击查看功能，包括 ImageViewerWindow 从 MaterialClient 迁移到 MaterialClient.UI 共享项目，以及 Urban 图片侧边栏中车牌识别抓拍和摄像头抓拍照片的点击交互。
